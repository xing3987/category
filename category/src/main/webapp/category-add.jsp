        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    <a href="${pageContext.request.contextPath}/CategoryList" class="list-group-item text-center ">生鲜列表</a>
                    ...
                    <div class="panel-body">
                        <form action="AddCategory" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="name" class="form-control" placeholder="生鲜名称">
                                </div>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="categoryFrom" class="form-control" placeholder="产地">
                                </div>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <label class="radio-inline">
                                        <input type="radio" name="categoryType" value="0" checked="checked">水果
                                    </label>
                                    <label class="radio-inline">
